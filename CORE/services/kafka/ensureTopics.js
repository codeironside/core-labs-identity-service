...
export const ensureIdentityKafkaTopics = async (topics = IDENTITY_REQUIRED_TOPICS) => {
    ...
    try {
        ...
        logger.warn({ error, topics }, '[IdentityKafka] Topic ensure failed — create topics manually in Confluent if the API key lacks CreateTopics');
    }
    finally {
